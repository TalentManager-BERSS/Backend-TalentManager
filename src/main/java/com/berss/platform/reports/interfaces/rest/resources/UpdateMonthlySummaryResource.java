...
public record UpdateMonthlySummaryResource(Integer totalHours, Integer completedHours, Integer score, Double inputAmount) {
    public UpdateMonthlySummaryResource {
